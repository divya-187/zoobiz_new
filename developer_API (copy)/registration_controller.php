...
if (isset($_POST) && !empty($_POST)) {
	...
	if ($key == $keydb) {
		...
		if ($_POST['getPackage'] == "getPackage") {
			...
			$app_data = $d->selectRow("inapp_ios_purchase_id, package_amount,package_id,gst_slab_id,package_name,package_amount,packaage_description,package_amount,package_amount,no_of_month,time_slab","package_master", " is_cpn_package = 0 and package_status=0", "");
