...
//check login end
				...
				if ($memberAdded > 0) {
					...
					while ($data = mysqli_fetch_array($q3)) {
						...
						if ($refer_by == "1") {
							$member_added_details["refer_by"] = "Social Media";} else if ($refer_by == "2") {$member_added_details["refer_by"] = "Member / Friend";} else if ($refer_by == "3") {$member_added_details["refer_by"] = "Other";}
				...
				*/
				...
				if (count($dataArray) > 0) {
					...
					for ($l = 0; $l < count($dataArray); $l++) {
						...
						if ($data_app["menu_title"] == "Classifieds" && $version_code >= 40 && $device == 'android' || $data_app["menu_title"] == "Classifieds" && $version_code >= 26 && $device == 'iOS') {
							$appmenu["menu_click"] = 'classified_new';
							$appmenu["ios_menu_click"] = 'classified_new';
						} else {
						...
						$appmenu["menu_font_color"] = "#606D7E";
						$appmenu["menu_font_type"] = "3"; // regular = 1 , medium = 2, semi_bold = 3, bold = 4
