                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      if (isset($_GET['paid_trans'])  && ($_GET['paid_trans'] == 1 || $_GET['paid_trans'] == 2 ) ) {   echo "-";  } else {
                        ...
                        ?> 
                        <a target="_blank"  href="../paymentReceipt.php?tId=<?php echo $transection_id; ?>&user_id=<?php echo $user_id; ?>&downloadInvoice=true&transection_date=<?php echo date("Y-m-d", strtotime($renew_date)); ?>" class=" btn-sm btn-info"><i class="fa fa-download"></i>Download</a>
                      <?php }  ?> 
                    </td>
