...
?>
                ...
                <form id="customClassifieds" action="controller/customController.php" method="POST" enctype="multipart/form-data">
                  <div class="form-group row">
                    <label for="input-10" class="col-sm-2 col-form-label">Select Multiple Cities
                      <span class="text-danger">*</span>
                    </label>

                    <div class="col-sm-10">
                      <select id="classifieds_sel_multiple_cities" required="" class="form-control classifieds_sel_multiple_cities-select" name="classifieds_sel_multiple_cities" type="text" >
	          ...
	          <?php if ($classifieds_sel_multiple_cities == "1") {?>
                  <div class="form-group row">
                    <label for="input-10" class="col-sm-2 col-form-label">All City Selection
                      <span class="text-danger">*</span>
                    </label>

                    <div class="col-sm-10">
                      <select id="classified_sel_city_all" required="" class="form-control classifieds_sel_multiple_cities-select" name="classified_sel_city_all" type="text" >
                        <option value="">-- Select --</option>
                        <option  <?php if ($classified_sel_city_all == "1") {?>selected <?php }?> value="1">Yes</option>
                        <option <?php if ($classified_sel_city_all == "0") {?>selected <?php }?> value="0">No</option>
                      </select>
                    </div>
                  </div>
		<?php } ?>
                  <div class="form-group row">
                    <label for="input-10" class="col-sm-2 col-form-label">Select Multiple Categories
                      <span class="text-danger">*</span>
                    </label>

                    <div class="col-sm-10">
                      <select id="classifieds_sel_multiple_categories" required="" class="form-control classifieds_sel_multiple_cities-select" name="classifieds_sel_multiple_categories" type="text" >
                          <option value="">-- Select --</option>
                          <option  <?php if ($classifieds_sel_multiple_categories == "1") {?>selected <?php }?> value="1">Yes</option>
                          <option <?php if ($classifieds_sel_multiple_categories == "0") {?>selected <?php }?> value="0">No</option>
                      </select>
                    </div>
                  </div>
		<?php if ($classifieds_sel_multiple_categories == "1") {?>
                  <div class="form-group row">
                    <label for="input-10" class="col-sm-2 col-form-label">All Categories Selection
                      <span class="text-danger">*</span>
                    </label>

                    <div class="col-sm-10">
                      <select id="classified_sel_category_all" required="" class="form-control classifieds_sel_multiple_cities-select" name="classified_sel_category_all" type="text" >
                          <option value="">-- Select --</option>
                          <option  <?php if ($classified_sel_category_all == "1") {?>selected <?php }?> value="1">Yes</option>
                          <option <?php if ($classified_sel_category_all == "0") {?>selected <?php }?> value="0">No</option>
                      </select>
                    </div>
                  </div>
		<?php } ?>
