...
if (isset($_POST) && !empty($_POST)) //it can be $_GET doesn't matter
{
	...
	//14april2021
		...
		$m->set_data('classifieds_sel_multiple_categories', $classifieds_sel_multiple_categories);
		$m->set_data('classified_sel_category_all', $classified_sel_category_all);
		$m->set_data('classified_sel_city_all', $classified_sel_city_all);
		$a = array(
			...
			'classifieds_sel_multiple_categories' => $m->get_data('classifieds_sel_multiple_categories'),
			'classified_sel_category_all' => $m->get_data('classified_sel_category_all'),
			'classified_sel_city_all' => $m->get_data('classified_sel_city_all'),
		);
		$q = $d->update("zoobiz_settings_master", $a, "setting_id ='$setting_id'");
